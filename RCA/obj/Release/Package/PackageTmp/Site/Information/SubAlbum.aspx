<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/WebSiteMasters/Site.Master" AutoEventWireup="true" CodeBehind="SubAlbum.aspx.cs"
 Inherits="RCA.Site.Information.SubAlbum" %>
    ...
    <div id="photoalbum_index">
        <asp:ListView ID="LV_Events" runat="server" OnItemDataBound="LV_Events_ItemDataBound">
            ...
            <ItemTemplate>
                <div>
                    <dl>
                        <dt><a href='<%# "../Information/SubAlbum_Gallery.aspx?ID=" + Eval("AlbumID")%>' title=""
                            target="_blank">
