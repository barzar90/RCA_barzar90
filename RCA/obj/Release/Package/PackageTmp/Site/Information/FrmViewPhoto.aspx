<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/WebSiteMasters/Site.Master"
    AutoEventWireup="true" CodeBehind="FrmViewPhoto.aspx.cs" Inherits="RCA.Site.Information.FrmViewPhoto" %>
                    ...
                    <ItemTemplate>
                         <div class="col-md-4">
                             <a class="vlightbox1" href='<%# DataBinder.Eval(Container.DataItem,"FileName") %>'
                                title="">
                                <asp:Image ID="Image1" runat="server" alt="View Event Photo" ImageUrl='<%# Eval("FileName")%>' />
                                <p>
