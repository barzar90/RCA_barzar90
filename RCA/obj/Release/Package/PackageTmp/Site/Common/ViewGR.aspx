<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/WebSiteMasters/Site.Master"
    AutoEventWireup="true" CodeBehind="ViewGR.aspx.cs" Inherits="RCA.Site.Common.ViewGR" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SitePH" runat="server">
    <div class="content">
        ...
        <h1>
            <asp:Label ID="lblGRHeading" runat="server" Text="Government Resolutions"></asp:Label>
        </h1>
        <div class="searchInner searchMarg">
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td width="100%" colspan="4" align="center" valign="bottom" height="40px">
        ...
        <div>
            <asp:GridView ID="grdGRList" runat="server" AllowPaging="true" PageSize="10" Width="100%"
                CssClass="tableClass" CellPadding="2" CellSpacing="2" GridLines="None" AutoGenerateColumns="false"
                HeaderStyle-BackColor="Green" OnPageIndexChanging="grdGRList_PageIndexChanging"
                OnRowCommand="grdGRList_RowCommand" OnDataBound="grdGRList_DataBound">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="GR No" HeaderStyle-Width="15%">
                        <ItemTemplate>
                            <asp:Label ID="lblgrdGRNo" runat="server" Text='<%# Eval("No") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
