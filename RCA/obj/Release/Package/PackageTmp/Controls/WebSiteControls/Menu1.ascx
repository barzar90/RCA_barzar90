<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Menu1.ascx.cs" Inherits="RCA.Controls.WebSiteControls.Menu1" %>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <asp:LinkButton ID="lnk_uploadfile" runat="server"
                            OnClick="lnk_uploadfile_Click">Upload Banner</asp:LinkButton></li>
                    <li>
