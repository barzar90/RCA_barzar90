<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Forms/AppForms.Master" AutoEventWireup="true" CodeBehind="CreateMenu.aspx.cs" Inherits="RCA.Admin.MenuManagement.CreateMenu" %>
    ...
    <div>
        ...
        <div class="hajdivtable">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                     <asp:Label runat="server" ID="lblSelectUser" Text="Select User"></asp:Label>
                </div>
                <div class="col-md-3">
                    <asp:DropDownList ID="drpSelectUser" CssClass="form-control" Visible="false" runat="server">
                         <asp:ListItem Value="0">Select</asp:ListItem>
                        <asp:ListItem Value="cmspune">Pune User</asp:ListItem>
                        <asp:ListItem Value="cmsnashik">Nashik User</asp:ListItem>
                        <asp:ListItem Value="cmsamravati">Amravati User</asp:ListItem>
                         <asp:ListItem Value="cmsaurangabad">Aurangabad User</asp:ListItem>
                        <asp:ListItem Value="cmskokan">Kokan User</asp:ListItem>
                        <asp:ListItem Value="cmsnagpur">Nagpur User</asp:ListItem>
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="rfvMenuUser" InitialValue="0" ForeColor="Red"
                        ControlToValidate="drpSelectUser" ValidationGroup="save" runat="server" ErrorMessage="Please select User." Enabled="false"></asp:RequiredFieldValidator>
                </div> 
            </div>
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ForeColor="Red" ControlToValidate="txtMTValue"
                        runat="server" ValidationGroup="save" ErrorMessage="please enter manu type value."></asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">
