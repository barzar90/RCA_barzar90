<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Forms/AppForms.Master" AutoEventWireup="true" CodeBehind="PlaceHolderList.aspx.cs" Inherits="RCA.Admin.MenuManagement.PlaceHolderList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FormsPH" runat="server">
     <table class="table table-bordered table-striped">
        <tr>
            <td>
                <div class="admintab">
                    <asp:Button ID="btnPlaceHolderList" runat="server" CssClass="btn btn-default btn-sm" Text="Add Place Holder Content" OnClick="btnPlaceHolderList_Click"/>
                    <asp:Button ID="btnBack" runat="server" Text="Back to Menu" CssClass="btn btn-danger btn-sm pull-right" OnClick="btnBack_Click" />
                    <div class="clear"></div>
                </div>
            </td>
        </tr>
