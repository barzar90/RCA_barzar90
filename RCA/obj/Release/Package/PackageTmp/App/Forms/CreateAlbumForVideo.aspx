<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Admin/adminMaster.Master"
    AutoEventWireup="true" CodeBehind="CreateAlbumForVideo.aspx.cs" Inherits="RCA.App.Forms.CreateAlbumForVideo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="table table-bordered table-striped">
        <tr>
            <td>
                <asp:Label ID="lblFileType" runat="server" Text="Select File Type"></asp:Label>
            </td>
            <td>
        ...
        <tr>
         ...
         <tr>
            <td>
                <asp:Label ID="Label6" runat="server" Text="Urdu Title"></asp:Label>
                <span>*</span>
            </td>
            <td>
        ...
        <tr>
           ...
           <tr>
            <td>
                <asp:Label ID="Label5" runat="server" Text="Urdu Description"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="lblVideoPath" runat="server" Text="English Video/Audio File"></asp:Label>
