        ...
        protected void btn_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtEditor1.Text.ToString() == "" || txtEditor1.Text.ToString() == string.Empty || txtEditor2.Text.ToString() == "" || txtEditor2.Text.ToString() == string.Empty)
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "Alert", "alert('Please Fill All Data !!!');window.location.href='PlaceHolderList.aspx';", true);
                    return;
                }
                if (!objvalid.ValidateHTML(txtEditor1.Text) || (!objvalid.ValidateHTML(txtEditor2.Text)))
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "Alert", "alert('Invalid Input !!!');window.location.href='PlaceHolderList.aspx';", true);
                    return;
                }
                if (UploadFile.HasFile)
                {
                    if (SaveUpload() == false)
                    {
                       // ScriptManager.RegisterStartupScript(this, this.GetType(), "Alert", "alert('Invalid Files !!!');window.location.href='PlaceHolderList.aspx';", true);
                        ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "Alert", "alert('Invalid Files !!!');window.location.href='PlaceHolderList.aspx';", true);
                        Clear();
                        return;
                    }
                }
                ...
                if (result != 0)
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "Message", "alert('Data saved Successfully !!!');window.location.href='PlaceHolderList.aspx'", true);
                }
                else
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "Message", "alert('Data Not saved !!!')window.location.href='PlaceHolderList.aspx';", true);
                }
            }
            catch (Exception ex)
            {
