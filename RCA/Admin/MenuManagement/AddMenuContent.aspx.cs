       ...
       // BL.BL MAHAITDBAccess;
        ...
        protected void btn_Save_Click(object sender, EventArgs e)
        {
            //if (Page.IsValid) {
                try
                {
                    RCA.WebServices.validateHtml objvalid = new WebServices.validateHtml();
                    bool flg = true;

                    if (txtEditor3.Text.ToString() == "" || txtEditor3.Text.ToString() == string.Empty || txtEditor4.Text.ToString() == "" || txtEditor4.Text.ToString() == string.Empty)
                    {
                        ...
                        ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "Alert", "alert(' Please Long Description !!!');window.location.href='MenuContentList.aspx?MenuID=" + Request.QueryString["MenuID"] + "';", true);
                        return;
                    }
                    if ((!objvalid.ValidateHTML(txtEditor1.Text)) || (!objvalid.ValidateHTML(txtEditor2.Text)) || (!objvalid.ValidateHTML(txtEditor3.Text)) || (!objvalid.ValidateHTML(txtEditor4.Text)))
                    {
                        flg = false;
                        txtEditor4.Text = "";
                    }
                    if (flg)
                    {
                        if (UploadFile.HasFile)
                        {
                            if (SaveUpload() == false)
                            {
                                ...
                                ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "Alert", "alert('Invalid Files !!!');window.location.href='MenuContentList.aspx?MenuID=" + Request.QueryString["MenuID"] + "';", true);
                                Clear();
                                return;
                            }
                        }
                        ...
                        if (result != 0)
                        {
                            ...
                            ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "Alert", "alert('Data saved Successfully !!!');window.location.href='MenuContentList.aspx?MenuID=" + Request.QueryString["MenuID"] + "';", true);
                        }
                        else
                        {
                            ...
                            ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "Alert", "alert('Data Not Saved !!!');window.location.href='MenuContentList.aspx?MenuID=" + Request.QueryString["MenuID"] + "';", true);
                        }
                    }
                    else
                    {
                        ...
                        ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "Alert", "alert('Invalid input !!!');window.location.href='MenuContentList.aspx?MenuID=" + Request.QueryString["MenuID"] + "';", true);
                    }
                }
                catch (Exception ex)
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "Alert", "alert('Please Insert Data !!!');window.location.href='MenuContentList.aspx?MenuID=" + Request.QueryString["MenuID"] + "';", true);
                }
        ...
        {
            //if(ScriptManager.RegisterStartupScript.)
