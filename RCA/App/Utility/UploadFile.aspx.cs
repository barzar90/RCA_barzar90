...
namespace RCA.App.Utility
{
    public partial class UploadFile : System.Web.UI.Page
    {
        ...
        //    try
        //    {
        //        ds = objUploadFileBL.BindCategory();
        //        //DDLcategory.DataSource = ds.Tables[0];
        //        //DDLcategory.DataTextField = "FileType";
        //        //DDLcategory.DataValueField = "FileTypeValue";
        ...
        //{
        //    if (DDLcategory.SelectedItem.ToString().ToLower() == "key persons")
        //    {
        //        lblFtitle.Text = "Name :";
        //        lblFtitleLL.Text = "नाव :";
        //        lblFdtl.Text = "Designation :";
        //        lblFDtlLL.Text = "पद  :";
        //    }
        //    else
        //    {
        //        lblFtitle.Text = "File Title :";
        //        lblFtitleLL.Text = "File Title In Marathi :";
        //        lblFdtl.Text = "File Details :";
        //        lblFDtlLL.Text = "File Details LL :";
        //    }
            ...
            try
            {
                if (e.CommandName == "delete")
                {
                    ...
                    if (retnval > 0)
                        ...
                        ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "Message", "alert('Record Deleted Sucessfully!!! ');", true);
                    else
                        //ScriptManager.RegisterStartupScript(this, typeof(Page), "Message", "alert('Record Not Deleted !!! ');", true);
                        ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "Message", "alert('Record Not Deleted !!! ');", true);
                }
                if (e.CommandName == "view")
                {
                    ...
                    UploadFileSchema objUploadFileSchema = new UploadFileSchema();
                    objUploadFileSchema.RowId = Convert.ToInt32(e.CommandArgument);
                    objUploadFileSchema.FileCategory = 20; //Convert.ToInt32(DDLcategory.SelectedValue);
        ...
        private bool checkfilecontenttype(FileUpload Fu)
        {
            ...
            if (Fu.HasFile)
            {
                ...
                Fu.FileContent.Read(header, 0, header.Length);
        ...
        private void SaveUpdateDB()
        {
            ...
            if (HdnDelete.Value != "0" && UploadImage.HasFile)
            {
                ...
                else
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "Alert", "alert('Supports Only " + HdnExt.Value + " File types Upto " + HdnSizeLimit.Value + " KB');", true);
                    return;
                }
            }
            ...
            if ((UploadImage.HasFile))
            {
                ...
                //{
                    if (imageHeight != 627 && imageWidth != 2000)
                    {
                        ...
                        ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "Alert", "alert('The Banner photograph should fall between 2000 to 627 pixels.');", true);
                        return;
                    }
                //}
                ...
                try
            {
                ...
                //objUploadFileSchema.FileDetailUL = null;// txtFDtlUL.Text;
                //objUploadFileSchema.FileTitleUL = null; //txtFTitleUL.Text;
                ...
                else
                {
                    ...
                    if (objUploadFileSchema.FileCategory == 1)
                    {
                        if (count >= 6)
                        {
                            ...
                            ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "Alert", "alert('Key Person should not be more than 6');", true);
                            return;
                        }
                    }
                ...
                if (retnVal > 0)
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "Message", "alert('Data saved Successfully !!!');", true);
                }
                BindGrid("20"); //DDLcategory.SelectedValue
            }
            catch (Exception ex)
            {
                throw ex;
