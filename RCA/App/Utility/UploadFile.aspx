<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Admin/adminMaster.Master"
    AutoEventWireup="true" CodeBehind="UploadFile.aspx.cs" Inherits="RCA.App.Utility.UploadFile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="table table-bordered table-striped">
        ...
        <%-- <tr>
            <td>
                <asp:Label ID="lblFtitleUL" runat="server" Text="File Title In Urdu"></asp:Label>
            </td>
            <td>
                <asp:TextBoxControl CssClass="form-control" ID="txtFTitleUL" runat="server" DestinationLanguage="URDU"
                    CDACDestinationLanguage="ENGLISH" TypingMode="GOOGLE"  AutoCompleteType="Disabled" autocomplete="off"></asp:TextBoxControl>
        ...
        <tr>
         ...
         <%--<tr>
            <td>
                <asp:Label ID="lblFDtlUL" runat="server" Text="File Details Urdu"></asp:Label>
            </td>
            <td>
