<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Admin/adminMaster.Master" AutoEventWireup="true" CodeBehind="UploadNews.aspx.cs" Inherits="RCA.App.Forms.UploadNews" %>
        ...
        <table class="table table-bordered table-striped">
            <tr>
                <td align="center">
                    <asp:DataGrid ID="dg_PDF" AutoGenerateColumns="False" ShowFooter="True" runat="server"
                        ...
                        <%--<asp:TextBox ID="txt_CreatedDate" runat="server" onkeydown="return isBS(event);" ></asp:TextBox>--%>
                                     <asp:TextBox ID="txt_CreatedDate" runat="server" CssClass="Date form-control" Width="150"></asp:TextBox>
                         <%--<asp:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy" TargetControlID="txt_CreatedDate" PopupButtonID="imgPopup"></asp:CalendarExtender>--%>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_CreatedDate" Display="Dynamic" SetFocusOnError="True" ValidationGroup="UPN" ForeColor="Red" Font-Size="X-Small" Text="*"></asp:RequiredFieldValidator>
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txt_CreatedDate" runat="server" Text='<%#  Eval("CreatedDate","{0:dd/MM/yyyy}") %>' CssClass="Date form-control"></asp:TextBox>
                                   ...
                                   <%-- <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy" TargetControlID="txt_CreatedDate" PopupButtonID="imgPopup"></cc1:CalendarExtender>--%>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_CreatedDate" Display="Dynamic" SetFocusOnError="True" ValidationGroup="VC" ForeColor="Red" Font-Size="X-Small" Text="*"></asp:RequiredFieldValidator>
                            ...
                            <asp:TemplateColumn HeaderText="News" ItemStyle-Width="50%">
                                ...
                                <FooterTemplate>
                                    <asp:TextBox ID="txt_News" runat="server" CssClass="form-control" Width="150"></asp:TextBox><span
                            ...
                            <asp:TemplateColumn HeaderText="News in Local Language" ItemStyle-Width="50%">
                                ...
                                <FooterTemplate>
                                    <cc1:TextBoxControl ID="txt_News_LL" runat="server" CssClass="form-control1 upload-news-textarea" DestinationLanguage="MARATHI"
                                        TypingMode="CDAC" CDACDestinationLanguage="MARATHI"
                           ...
                           <%-- <asp:TemplateColumn HeaderText="News in Urdu Language" ItemStyle-Width="50%">
                                <ItemTemplate>
                                ...
                                <FooterTemplate>
                                    <cc1:TextBoxControl ID="txt_News_UL" runat="server" CssClass="formn-control" DestinationLanguage="Urdu"
                           ...
                           <asp:TemplateColumn HeaderText="Is PDF/URL">
                            ...
                            <asp:TemplateColumn HeaderText=" URL / SelectFile" ItemStyle-Width="16%">
                                <ItemTemplate>
                                    <a href='<%#Eval("URL")%>'>
                                        <asp:Label ID="lbl_URL" runat="server" Text='<%# Bind("URL") %>' CssClass="uploadnews-width"  Width="200"/>
                                    </a>
                                </ItemTemplate>
                                <FooterTemplate>
                                    <asp:TextBox ID="txt_URL" runat="server" Width="90%" Height="40px" Visible="false"></asp:TextBox>
                                    <asp:FileUpload ID="UploadFile" runat="server" Width="200" />
                                </FooterTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="txt_URL" runat="server" Width="90%" Height="40px" Visible="false"></asp:TextBox>
                            ...
                            <asp:TemplateColumn HeaderText="Active">
                                <ItemTemplate>
                                    <asp:CheckBox ID="chk_Is_Active" runat="server" Checked='<%# Convert.ToBoolean(Eval("Is_Active")) %>'
                                        AutoPostBack="true" OnCheckedChanged="chk_Is_Active_CheckedChanged" /> <%--AutoPostBack="true"--%>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            ...
                            <asp:EditCommandColumn UpdateText="Update" CancelText="Cancel" ItemStyle-CssClass="btn btn-info btn-info1" EditText="Edit" HeaderText="Edit">
                                <HeaderStyle Width="10%" />
                            </asp:EditCommandColumn>
                            <asp:TemplateColumn HeaderText="Delete">
                                <FooterTemplate>
                                   <%-- <asp:LinkButton ID="lbtn_Add" Text="Add" runat="Server" CssClass="btn btn-success" CommandName="Add" ValidationGroup="UPN" ClientIDMode="Static" causesValidation=false/>--%>
                                    <asp:Button ID="lbtn_Add" Text="Add" runat="Server" CssClass="btn btn-success"  ValidationGroup="UPN" CommandName="Add" CausesValidation="false" />
                                </FooterTemplate>
                                <ItemTemplate>
                                    <span onclick="return confirm('Are you sure to Delete?')">
                                        <%--<asp:LinkButton ID="lbtn_Delete" runat="Server" Text="Delete" CssClass="btn btn-danger" CommandName="Delete" />--%>
                                        <asp:Button ID="lbtn_Delete" Text="Delete" runat="Server" CssClass="btn btn-danger" CommandName="Delete" CausesValidation="false" />
                                    </span>
                                </ItemTemplate>
                                <HeaderStyle Width="5%" />
                            </asp:TemplateColumn>
