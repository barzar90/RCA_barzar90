...
namespace RCA.App.Forms
{
    public partial class CreateAlbumForVideo : System.Web.UI.Page
    {
        ...
        Label ID, Name; TextBox txtPhotoName, txtPhotoNameLL; FileUpload FileUpload;       
        DataSet ds;
        DataTable dt;
                    ...
                    if (uploadImage.HasFile)
                    {
                        ...
                        else
                        {
                           // ScriptManager.RegisterStartupScript(this, typeof(Page), "msg", "alert('Invalid Image File');", true); ;
                            ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "msg", "alert('Invalid Image File');", true);
                            return;
                        }
                    }
        ...
        private int SavetoDB()
        {
            ...
            {               
                ...
                objAlbumSchema.VideoPath = uploadVideo.FileName;
                objAlbumSchema.ImagePath = uploadImage.FileName;
