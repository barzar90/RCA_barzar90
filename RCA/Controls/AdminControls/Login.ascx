<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Login.ascx.cs" Inherits="RCA.Controls.AdminControls.Login" %>
...
<script language="javascript" type="text/javascript">
 ...
 <script type="text/javascript">
    ...
    function ValidCaptcha() {
        ...
        var str2 = removeSpaces(document.getElementById('txtimgcode').value);
        if (str1 == str2)
            return true;
        else
            //return false;
        alert("InCorrect Captcha Validation");
...
<asp:Login ID="LoginUser" runat="server" EnableViewState="false" RenderOuterTable="false"
    OnLoggedIn="RedirectUser" OnAuthenticate="CreateLoginAudit" onload="DrawCaptcha();">
                ...
                <div class="panel panel-warning">
                    ...
                    <div style="padding-top: 30px" class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="UserName" runat="server" autocomplete="off" CssClass="form-control" placeholder="Username"></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group">
                              <asp:Label ID="lblNote" runat="server" Text="Case Sensitive" CssClass="addInfo"></asp:Label><span
                                    id="sp_captcha" runat="server" style="color: Red">*</span>
                            <input type="text" id="txtCaptcha" style="background-image: url(../../Images/1.jpg); text-align: center; border: none; font-weight: bold; font-family: Modern" />
...
<%--                                        <asp:Button ID="LoginButton" runat="server" CommandName="Login" Text="Log In" CssClass="btn btn-success"
                                            ...
                                            <asp:Button ID="LoginButton" runat="server" CommandName="Login" Text="Log In" CssClass="btn btn-success"
                                            ValidationGroup="LoginUserValidationGroup" CommandArgument="Submit" OnClick="LoginButton_Click" OnClientClick="alert(ValidCaptcha());" />
