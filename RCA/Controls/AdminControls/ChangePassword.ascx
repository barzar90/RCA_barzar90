<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChangePassword.ascx.cs" Inherits="RCA.Controls.AdminControls.ChangePassword" %>
        ...
        <asp:ValidationSummary ID="ChangeUserPasswordValidationSummary" runat="server" CssClass="failureNotification"
            ...
            <fieldset class="login">
                <legend>Account Information</legend>
                    ...
                    <asp:TextBox ID="CurrentPassword" runat="server" CssClass="passwordEntry" TextMode="Password" autocomplete="off"></asp:TextBox>
