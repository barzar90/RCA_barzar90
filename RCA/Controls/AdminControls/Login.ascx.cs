...
namespace RCA.Controls.AdminControls
{
    public partial class Login : System.Web.UI.UserControl
    {
        ...
        protected void Page_PreRender(object sender, EventArgs e)
        {
            ...
            //ForgotPassword.Text = _MahaITUC.GetResourceValue("Resource", "btnBack", "Case Entry");
            ...
            if(Session["CaptchaImageText"] != null) {
                if (txtimgcode1.Text == Session["CaptchaImageText"].ToString())
                {
                    ...
                    if (user != null)
                    {
                        ...
                        strPassword = ObjLoginBL.GetUserPassword(OBJloginSchema).ToUpper();
                ...
                else
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "Message", "alert('Incorrect Captcha Value !! Try again.');", true);
                }
            }
            else {
                txtimgcode1.Text = string.Empty;
        ...
        protected void RedirectUser(object sender, EventArgs e)
        {
            ...
            if (user != null)
            {
                ...
                else if (Convert.ToString(Roles.GetRolesForUser(userName.Text)[0]).ToLower() == "cmscityuser")
                {
                    Response.Redirect("~/Admin/MenuManagement/CityUserMenuList.aspx");
                }
                else
                {
        ...
        protected void LoginUser_ForgotPassword(object sender, EventArgs e)
        {
            ...
            if (userName.Text == string.Empty)
            {
                ...
                ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "Message", "alert('Please enter user name ');", true);
                return;
            }
            MembershipUser user = Membership.GetUser(userName.Text);
            if (user != null)
            ...
            else
            {
               // ScriptManager.RegisterStartupScript(this, typeof(Page), "Message", "alert('Invalid UserName');", true);
                ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "Message", "alert('Invalid UserName');", true);
            }
        }
        ...
        public void InsertUserSession()
        {
            try
            {
                ...
                else
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "Message", "alert('More than 3 attempts of Login is invalid.');", true);
