...
<script type="text/javascript">
    //$("#lbl_skipToContent").click(function () {
    //    alert("The paragraph was clicked.");
    //    $(".other_links").hide();
    //    $(".searchBox").hide();
    //});

    function hdnSkipToContent() {    
        $(".other_links").hide();
        $(".searchBox").hide();
}
</script>
        ...
        <div class="container ">
            <ul class="other_links">
                <asp:LoginView ID="HeadLoginView" runat="server" EnableViewState="false">
                    <AnonymousTemplate>
                        <li class="m_hide">
                            <asp:Button ID="btnlogin" runat="server" OnClick="btnlogin_Click" CssClass="btnResizer"></asp:Button></li>
                    </AnonymousTemplate>
                    <LoggedInTemplate>
                ...
                <li class="m_hide"><a href="#Content">
                    <asp:Label ID="lbl_skipToContent" onClick="hdnSkipToContent()" runat="server" Text=""></asp:Label></a></li>
