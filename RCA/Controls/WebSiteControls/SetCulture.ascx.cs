...
namespace RCA.Controls.WebSiteControls
{
    public partial class SetCulture : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["User"] != null && Session["AuthToken"] != null && Request.Cookies["AuthToken"].Value != string.Empty)
            {
                if ((Session["AuthToken"].ToString() == Request.Cookies["AuthToken"].Value))
                {
                    ...
                    {
                        this.Controls.Remove(btn_Smallest);
                        this.Controls.Remove(btn_Medium);
                        this.Controls.Remove(btn_Larger);
                        this.Controls.Remove(btnABlack);
                        this.Controls.Remove(btnAWhite);
                    }
                    else
                    {
                        this.Controls.Add(btn_Smallest);
                        this.Controls.Add(btn_Medium);
                        this.Controls.Add(btn_Larger);
                        this.Controls.Add(btnABlack);
                        this.Controls.Add(btnAWhite);
                    }
                }
            }
        }
        ...
        {
            RCA.PublicApp.API.MAHAITAPI.SetCulture(btn_Language.Text);
        ...
        protected void DDL_Language_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            RCA.PublicApp.API.MAHAITAPI.SetCulture(DDL_Language.SelectedValue);
