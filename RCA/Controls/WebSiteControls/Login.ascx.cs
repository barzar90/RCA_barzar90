    ...
    public partial class Login : System.Web.UI.UserControl
    {
        ...
        protected void CreateLoginAudit(object sender, System.Web.UI.WebControls.AuthenticateEventArgs e)
        {
            ...
            if (txtimgcode1.Text == Session["CaptchaImageText"].ToString())
            {
                ...
                //MembershipUser user2 = Membership.Providers["AspNetSqlMembershipProvider"].GetUser(_Username.Text, false);
                ...
                if (user != null)
                {
                    ...
                    //cmd.Parameters.AddWithValue("@UserName ", _Username.Text);
                    ////cmd.Parameters.AddWithValue("@QueryNo",1);
                    //cmd.CommandType = CommandType.StoredProcedure;
                    //cmd.CommandText = "[uspGetUserPassword]";
        ...
        protected void LoginUser_ForgotPassword(object sender, EventArgs e)
        {
            ...
            if (user != null)
            {
                ...
                cmd.Parameters.AddWithValue("@Password ", EncryptMD5(t_Passsword));
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                MahaITLDBAccess = new BL.BL(System.Configuration.ConfigurationManager.AppSettings["APPID"].ToString());
                MahaITLDBAccess.SendEmailuser("forgotpassword_user", "", Membership.GetUser(userName.Text).Email.ToString(), "", t_Passsword, t_username);
