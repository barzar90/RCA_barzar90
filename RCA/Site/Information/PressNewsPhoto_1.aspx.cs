...
{
    public partial class PressNewsPhoto_1 : System.Web.UI.Page
    {
        public int AlbumID;
        ...
        public void GetData()
        {
            ...
            DataSet ds = Helper.SQLHelper.ExecuteDataset(conn, null, CommandType.StoredProcedure, "sp_GetPressNewsPhotoID_Anjani", cmmParameters);
