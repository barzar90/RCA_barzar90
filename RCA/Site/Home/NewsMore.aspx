<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/WebSiteMasters/Site.Master" AutoEventWireup="true" CodeBehind="NewsMore.aspx.cs" Inherits="RCA.Site.Home.NewsMore" %>
...
<ul class="list-group">
  <li class="list-group-item">
      <div class="col-md-8 col-sm-8">
         <asp:Label ID="lblSearch" Text="Enter A KeyWord To Search : " runat="server" AssociatedControlID="txtSearch"></asp:Label>
...
<div class="table-responsive">
    <asp:UpdatePanel ID="upNews" runat="server">
        <ContentTemplate>
            <asp:GridView ID="gvNews" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-condensed table-striped t_view"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="तारीख" SortExpression="Date" HeaderStyle-Width="10%">
                        <ItemTemplate>
                            <asp:Label ID="lblDate" runat="server" TextMode="Date" Text='<%#  Bind("Date") %>'></asp:Label>
<%--                                <asp:TextBox ID="lblDate" runat="server" Text='<%# Bind("Date", "{0:yyyy-MM-dd}") %>' TextMode="Date"></asp:TextBox>--%>
                        </ItemTemplate>
                    </asp:TemplateField>
