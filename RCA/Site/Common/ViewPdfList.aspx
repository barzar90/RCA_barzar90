<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/WebSiteMasters/Site.Master"
    AutoEventWireup="true" CodeBehind="ViewPdfList.aspx.cs" Inherits="RCA.Site.Common.ViewPdfList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="SitePH" runat="server">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-3">
                <asp:Button ID="btnSearch" runat="server" Text="Search" CssClass="btn btn-primary"
                    ValidationGroup="GR" OnClick="btnSearch_Click" />
    ...
    <div class="table-responsive">
        <asp:GridView ID="grdupload" CssClass="table table-bordered table-striped" runat="server"
            AutoGenerateColumns="False" GridLines="Vertical" Width="100%" PageSize="10" AllowPaging="true"
            OnPageIndexChanging="grdupload_PageIndexChanging">
            <Columns>
     ...
     <h1>
     <asp:Button ID="btn_Archive" runat="server" CssClass="btn btn-primary"
