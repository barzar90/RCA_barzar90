    ...
    public partial class MAHAITAPI : MAHAITValidate
    {
        public static List<MAHAITResponse> SetCulture(string CurrentCulture)
        {
            ...
            else
            {
                ...
                System.Threading.Thread.CurrentThread.CurrentCulture = new System.Globalization.CultureInfo("ur");
                HttpContext.Current.Profile.SetPropertyValue("Selectedlanguage", "ur");
            }
