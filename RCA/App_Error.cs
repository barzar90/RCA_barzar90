...
namespace RCA
{
    public class App_Error : MAHAITPage
    {
        ...
        {
            DataSet source;
            //objAppErrorSchema.ErrorId = !string.IsNullOrWhiteSpace(this.lExceptionId.Text) ? Convert.ToInt32(this.lExceptionId.Text) : 0; //Real 9-4-18
