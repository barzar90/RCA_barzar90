(function ($, window, document, undefined) {
	...
	var defaults = {
		...
		urlParams: {
            appid: "92dc516761ab79d7549453f569efe533", //,bd5e378503939ddaee76f12ad7a97608, ,'92dc516761ab79d7549453f569efe533',
			cnt: 1,
			units: 'metric',
			lang: 'en'
		}
	...
	$.extend(Plugin.prototype, {
		...
		_renderCheckBox: function() {
            $(this.element).find('.weather__checkbox').attr('src', `../../Images/weather/dialog_checkbox${this.settings.fixLocation ? '_selected' : ''}.png`);
		},
        ...
        _render: function (obj)
        {
			...
			var element = $(this.element);
			if (obj) {
				template = `<div class="weather__widget">
				<img class="weather__checkbox">
				<label class="weather__name-cityfont">${obj.name}, ${obj.country}</label><br>
				<div class="weather__wrapper">
				<img class="weather__img" title="${obj.description}" src="../../Images/weather/${this._icons[obj.icon]}.png"><br>
				<div class="weather__text__wrapper">
				<span class="weather__main-temp">+${obj.tempCur}&deg;${this.settings.tempUnit}</span>
				
				${this.settings.displayMinMaxTemp ? `<span class="weather__info">+${obj.tempMax}&deg;${this.settings.tempUnit}</span>
				<span class="weather__info_min">+${obj.tempMin}&deg;${this.settings.tempUnit}</span><br>` : ''}
                ...
                template = `<div class="weather__sub">
