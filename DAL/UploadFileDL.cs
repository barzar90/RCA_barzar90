    ...
    public class UploadFileDL
    {
        ...
        public int DeleteFileDL(UploadFileSchema objUploadFileSchema)
        {
            try
            {
                ...
                //sqlQuery = "update MOLFileUpload set IsDeleted=1 where RowID=@RowID";
        ...
        public DataSet ShowFileDetailsdDL(UploadFileSchema objUploadFileSchema)
        {
            ...
            try
            {
                ...
                cmdParameter[0].Value = objUploadFileSchema.RowId;
                //Added By K.P
                //sqlQuery = "select a.FileTitle,a.FileTitleLL,a.FileDtl,a.FileDtlLL,a.IsActive,a.SequenceNo,b.FileExtension,b.FileSize_KB,a.FileTitleUL,a.FileDtlUL from MOLFileUpload a, MOLFileCategory b where a.RowId=@RowId and a.FileCategory=b.FileTypeValue";
